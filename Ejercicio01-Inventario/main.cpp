...
void ajusteNegativoDeInventario() {
    ...
    system("cls");
    cout << endl;
    cout << "Ajuste negativo al Inventario" << endl;
    cout << "**********************************" << endl;
    cout << "Ingrese el codigo del producto: ";
    cin >> codigo;
    cout << endl;
    cout << "Ingrese la cantidad del producto a restar: ";
    cin >> cantidad;
    cout << endl;
...
int main(int argc, char const *argv[])
{
    ...
    while(true) {
        ...
        cout << "4 - Ajuste Negativo al Inventario" << endl;
        cout << "5 - Ajuste Positivo al Inventario" << endl;
        cout << "0 - Salir" << endl;
        cout << "Ingrese una opcion del menu: ";
        cin >> opcion;

        //Posibles acciones segun la opcion seleccionada en el menu
        switch (opcion)
        {
        case 1: 
            listarProductos();            
